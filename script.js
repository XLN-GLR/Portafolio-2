...
Estudiante de Informática en Montepiedra. Mi enfoque es "Tecnología con estrategia: soluciones que generan valor". Optimizo plataformas de bases de datos y nubes para que sean altamente escalables, resilientes y eficientes.`;
  ...
  3. <span class="term-accent">Gestión de Riesgos MTP</span> (Mitigación estructural de desastres - Python/MySQL)`;
    ...
    // ==========================================================================
    // 9. EFECTO DE LLUVIA DIGITAL MATRIX HACKER (GLOBAL CANVAS BACKGROUND)
    // ==========================================================================
    function initMatrixBackground() {
        ...
        // Dimensiones del canvas en pantalla completa
        let width = canvas.width = window.innerWidth;
        let height = canvas.height = window.innerHeight;

        // Caracteres hacker: binarios y hexadecimales en mayúsculas
        const alphabet = '01010101010101010101010101010101ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789';
        const fontSize = 14;
        let columns = Math.floor(width / fontSize);

        // Desfases iniciales para que la lluvia fluya asincrónicamente y no empiece junta
        const rainDrops = [];
        ...
        const draw = () => {
            // Capa negra con opacidad sutil para dar el rastro fantasmal "trail"
            ctx.fillStyle = 'rgba(0, 0, 0, 0.05)';
            ctx.fillRect(0, 0, width, height);

            // Letras en verde neón hacker
            ...
            for (let i = 0; i < rainDrops.length; i++) {
                ...
                // Resetear al fondo de forma aleatoria
        ...
        // Intervalo controlado a 30 FPS para un rendimiento soberbio con nulo impacto en batería/CPU
        let matrixInterval = setInterval(draw, 33);

        // Recalcular tamaño con resize y regenerar las columnas de forma matemática exacta
